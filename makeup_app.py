...
class MakeupApplication:
    ...
    def apply_blush(self, frame, left_cheek_indices, right_cheek_indices, color=(130, 119, 255), alpha=0.3, blur_radius=15):
        ...
        if result.multi_face_landmarks:
            ...
            for face_landmarks in result.multi_face_landmarks:
                ...
                # Draw filled polygons on the mask for both cheeks
    ...
    def process_frame(self, frame):
        ...
        if results.multi_face_landmarks:
            for face_no, face_landmarks in enumerate(results.multi_face_landmarks):
                ...
                frame = self.apply_blush(frame,left_eye_shadow_C,right_eye_shadow_C,blur_radius=9,alpha= 0.2, color = (91,123,195) )
        return frame
